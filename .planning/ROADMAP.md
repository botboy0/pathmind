...
- [x] 03-02-PLAN.md — Wave 1: Pathmind enabling API — AddonNodeInputHandler + bodyHeight + NodeDimensionCalculator ADDON branch + NodeGraph focus/input/overlay wiring + screen dispatch + mavenLocal republish [pathmind]
...
- [x] 03-04-PLAN.md — Wave 3: EDIT-02 line-number gutter + EDIT-03 co-located error strip — gutter/error draw passes + serializer schema v2 + executor error write-back [pathmind-lua]
